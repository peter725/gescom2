...
public class ProductServiceController extends AbstractCrudController<ProductServiceEntity, ProductServiceDTO, Long, ProductServiceCriteria> {
    ...
    @GetMapping("/data/{id}")
    public ResponseEntity<Page<ProductServiceEntity.SimpleProjection>> findListByCriteria(ProductServiceCriteria servicesCriteria, @PathVariable  Long id) {
        Page<ProductServiceEntity.SimpleProjection> result =
