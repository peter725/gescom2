...
export const crudOperationsStorageFactory = () => {
  const apiOperations: OperationsDefSrc = {
    ...
    responsibleEntity: { type: HttpOperationType.CRUD, path: `/autonomous_communitys` },
    campaignType: { type: HttpOperationType.CRUD, path: `/campaign_type` },
    participants: { type: HttpOperationType.CRUD, path: `/autonomous_communitys` },
    ...
    infractions: { type: HttpOperationType.CRUD, path: '/infractions', },
